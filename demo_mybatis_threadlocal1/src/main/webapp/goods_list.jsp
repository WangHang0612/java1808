                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">${good.skuCost}</td>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                <ul class="pagination">
                                                    ...
                                                    <li><a href="goods.do?page=2" class="active">2</a></li>
                                                    <li><a href="goods.do?page=3" class="active">3</a></li>
                                                    <li><a href="goods.do?page=4" class="active">4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
